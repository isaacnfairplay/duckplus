...
1. Update the Sphinx configuration to advertise DuckPlus 1.4.2 so doc builds label the upcoming release correctly.【F:docs/conf.py†L19-L20】
2. Refresh the version switcher JSON so published sites offer the 1.4.2 guides alongside prior releases and the rolling ``latest`` channel.【F:docs/_static/version_switcher.json†L1-L27】
