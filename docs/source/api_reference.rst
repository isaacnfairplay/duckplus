...
autodoc tables to inspect the full callable signatures. Furo already provides a
sidebar table of contents, so this page relies on that built-in navigation.
